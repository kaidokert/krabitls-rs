...
- **client cert** — mutual TLS: the client also sends a Certificate +
  CertificateVerify (the client-auth signature).

Peak stack is per-record-schedule storage plus the deepest crypto chain; the
bulk of a large row is the asymmetric primitive (ML-DSA / ML-KEM / RSA), not the
protocol.
...
| X25519          | AES-128-GCM       | RSA-2048-PSS | RSA-2048-PSS |        55.4 |    47 268 |
...
| X25519          | AES-128-GCM       | RSA-2048-PSS | RSA-2048-PSS |        87.8 |    46 892 |
