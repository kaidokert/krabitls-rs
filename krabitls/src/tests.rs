...
fn fixture_dhe_via_x25519() {
    ...
    let dhe =
        ed25519_heapless::hazmat::x25519::<T>(&FIXTURE_CLIENT_X25519_PRIV, &FIXTURE_SERVER_X25519_PUB_2)
...
fn jedisct_matches_rustcrypto() {
    ...
    let dhe =
        ed25519_heapless::hazmat::x25519::<Bn>(&FIXTURE_CLIENT_X25519_PRIV, &FIXTURE_SERVER_X25519_PUB_2)
            .expect("x25519 infallible on >=256-bit carrier");
