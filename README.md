...
- Pluggable crypto backends: a custom `ClientConfig` swaps in its own key exchange (`Kx`), signature verifiers, AEAD, or client signer — e.g. a hardware accelerator — behind the bundled RustCrypto defaults
