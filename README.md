...
- Hand-rolled and unaudited; constant-time primitives, with opt-in power/EM-DPA blinding (TLS key exchange + signing) behind the `blinding` feature — DTLS's X25519 is not yet blinded
